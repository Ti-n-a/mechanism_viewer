...
def build_distribution_of_missingness(df: pd.DataFrame, missing_col: str):
    ...
    Parameters:
    data (pd.DataFrame): The dataframe that will be used for plotting
    missing_col (str): The column with missing values, that will be used to group the other columns into 2 groups:
